...
const EmployeeSet = ({ set, onEdit, type }) => {
  const months = [
    ...
    <div className="item-set">
      ...
      <div className="set-data">
        ...
        <div className="set-column-1" style={{width:"25%"}}>
              ...
              {set.manager_of && set.manager_of.length > 0 > 0 ? <button className='neon-button-outline text-small-white-bold' style={{padding:"1rem 0"}}>MANAGER</button> : <button className='neon-button-outline text-small-white-bold' style={{padding:"1rem 0"}}>STAFF</button>}
